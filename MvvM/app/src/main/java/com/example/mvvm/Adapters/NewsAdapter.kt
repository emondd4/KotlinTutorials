...
import com.example.mvvm.DataClass.Article
...
class NewsAdapter: RecyclerView.Adapter<NewsAdapter.ArticleViewHolder>() {
    override fun onCreateViewHolder(
        ...
        return ArticleViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.list_article_preview,parent,false))
    }
